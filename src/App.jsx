      ...
      <main className="flex-grow px-5 py-15">
        <div className="min-w-xl pl-40 pr-40">
          ...
          <div className="grid grid-cols-2 gap-6">
            ...
            <div>
              <Inputs
                ...
                isSelect={true}
                options={["BS Tourism", "BS Accountancy", "BS Business Administration", "BS Information Technology", "BS Nursing"]}
              ></Inputs>
            </div>
          ...
          <div className="flex justify-between items-center mt-8">
            <Button variant="outline" className="w-26 h-9">Clear</Button>
